        ...
        <div class="hero mt-40">
            ...
            <div class="hero-content flex-col lg:flex-row">
                ...
                <div className='text-white'>
                    ...
                    <h1 class="text-5xl font-bold">Make Your Appointment Now</h1>
                    <p class="py-6">Our service is free for all the time. You can book your appointment any time. Our assistants are very cooperative.</p>
